          ...
          <div className='xl:w-[424px] lg:w-[380px] w-full bg-[#F7F8FA]'>
            <div className='p-6'>
                <Image src={quote} alt='' width={48} height={48}/>
                 ...
                 <p className='mt-6 text-[#69778C] text-[18px] font-normal leading-8 '>I have worked with many web designers in the past and I can say that I have never had an experience like this. I have been working with Figma for a few months now and it has been a unique experience. </p>
          ...
          <div className='xl:w-[424px] lg:w-[380px] w-full bg-[#F7F8FA]'>
            <div className='p-6'>
                <Image src={quote} alt='' width={48} height={48}/>
                 ...
                 <p className='mt-6 text-[#69778C] text-[18px] font-normal leading-8 '>I would like to recommend the website design services of the talented Figma. I had the distinct pleasure of working with their team to build my new website. T</p>
          ...
          <div className='xl:w-[424px] lg:w-[380px] w-full bg-[#F7F8FA]'>
            <div className='p-6'>
                <Image src={quote} alt='' width={48} height={48}/>
                 ...
                 <p className='mt-6 text-[#69778C] text-[18px] font-normal leading-8 '>I am thinking about starting a business in mobile app design. came across this website and thought this would be a great place to start. </p>
